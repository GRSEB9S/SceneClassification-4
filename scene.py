...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--train_dir',
        type=str,
        default='data/ai_challenger_scene_train_20170904/scene_train_images_20170904/',
        help="""\
    ...
    parser.add_argument(
        '--annotations',
        type=str,
        default='data/ai_challenger_scene_train_20170904/scene_train_annotations_20170904.json',
        help="""\
    ...
    parser.add_argument(
        '--test_dir',
        type=str,
        #default='data/ai_challenger_scene_validation_20170908/scene_validation_images_20170908/',
        default='data/ai_challenger_scene_test_a_20170922/scene_test_a_images_20170922/',
        help="""\
